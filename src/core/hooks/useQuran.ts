...
import { GetSurahUseCase } from '../../features/quran-reading/domain/usecases/GetSurahUseCase';
import { GetAllSurahsUseCase } from '../../features/quran-reading/domain/usecases/GetAllSurahsUseCase';
